...
function openAnimeModal(anime) {
  ...
  animeModal.innerHTML = `
    ...
    <div class="relative w-full h-full flex items-center justify-center">
      ...
      <div class="relative bg-white dark:bg-gray-900
           ...
           id="animeModalContent">

        <!-- HEADER -->
        <div class="flex fixed max-w-6xl w-[95%]
                    items-center justify-between h-14
                    bg-gray-800 text-white px-0">
          <span class="font-semibold text-lg pl-4">Anime Details</span>
  ...
  animeModal.addEventListener("click", closeAnimeModal);

  /* ---------- PREVENT CLOSE WHEN CLICKING INSIDE ---------- */
  document
    .getElementById("animeModalContent")
